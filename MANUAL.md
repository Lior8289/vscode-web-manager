...
WebSocket upgrade is failing. Check that nginx has `proxy_http_version 1.1` and the Upgrade/Connection headers (in `deploy/nginx.conf`, baked into the frontend/nginx image). Also try:
